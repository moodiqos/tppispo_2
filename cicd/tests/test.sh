...
OUTPUT=$($PROGRAM_PATH "1 2 3" "2 3 1" "3 1 2")
...
OUTPUT=$($PROGRAM_PATH "1 2 3" "2 3 1" "3 2 2")
...
# Тест 3: Проверка с квадратом, содержащим дубликаты в строках
echo "Тест 3: Проверка с дубликатами в строках"
OUTPUT=$($PROGRAM_PATH "1 2 3" "1 2 3" "3 1 2")
EXPECTED="Матрица не является латинским квадратом."
if [ "$OUTPUT" == "$EXPECTED" ]; then
